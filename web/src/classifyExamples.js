...
//
// Two tickets were removed after a stability check: as:5579173328 and
// as:13585202841. Both are labelled correctly by hand and both come back wrong
// three times out of three, for the same reason - the model does not register
// that the money has NOT moved yet. One loses it as an urgency fact (a charge is
// coming, so P2), the other as the step (cancel_only, not a refund). That
// failure is documented; it is not what a demo button should demonstrate.
//
